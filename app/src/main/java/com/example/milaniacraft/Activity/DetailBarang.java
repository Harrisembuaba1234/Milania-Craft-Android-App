    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(numberOrder == 0){
                    Toast.makeText(DetailBarang.this, "harap tentukan jumlah dahulu", Toast.LENGTH_SHORT).show();
                    ...
                    call.enqueue(new Callback<ResponseCart>() {
                        ...
                        public void onResponse(Call<ResponseCart> call, Response<ResponseCart> response) {
                            ...
                            Toast.makeText(DetailBarang.this, "Kode : "+kode, Toast.LENGTH_SHORT).show();
