...
import com.example.milaniacraft.RincianDibatalkan;

import java.text.DecimalFormat;
import java.text.DecimalFormatSymbols;
import java.util.List;

public class AdapterBatal extends RecyclerView.Adapter<AdapterBatal.HolderDataBaru> {

    Context ctx;
    List<DataHistory> list;
    Intent intent;
    public AdapterBatal(Context ctx, List<DataHistory> list, Intent intent) {
        this.ctx = ctx;
        this.list = list;
        this.intent = intent;
    }
    ...
    @NonNull
    @Override
    public AdapterBatal.HolderDataBaru onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(ctx).inflate(R.layout.card_history, parent, false);
        return new AdapterBatal.HolderDataBaru(layout);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterBatal.HolderDataBaru holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.TvHistory.setText(String.valueOf(" Telah dibatalkan"));
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mIntent =  new Intent(view.getContext(), RincianDibatalkan.class);
                ...
                mIntent.putExtra("waktu_dibatalkan", list.get(position).getWaktuDibatalkan());
