...
public class AdapterKirim extends RecyclerView.Adapter<AdapterKirim.HolderDataBaru> {

    Context ctx;
    List<DataHistory> list;
    Intent intent;
    public AdapterKirim(Context ctx, List<DataHistory> list, Intent intent) {
        this.ctx = ctx;
        this.list = list;
        this.intent = intent;
    }
    ...
    @NonNull
    @Override
    public AdapterKirim.HolderDataBaru onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(ctx).inflate(R.layout.card_history, parent, false);
        return new AdapterKirim.HolderDataBaru(layout);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterKirim.HolderDataBaru holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mIntent =  new Intent(view.getContext(), RincianDikirim.class);
